...
class LiteLLMProvider(LLMProvider):
    ...
    def __init__(
        self, api_key: str | None = None, api_base: str | None = None, default_model: str = "anthropic/claude-opus-4-5"
    ):
        ...
        # Detect nano-gpt by model name
        self.is_nanogpt = (api_key and api_key.startswith("sk-nano-")) or ("nanogpt" in default_model.lower())
